document.addEventListener("DOMContentLoaded", function () {
  ...
  async function fetchMenuItems() {
      try {
          ...
          menuList.innerHTML = ""; // Clear existing table content
          ...
          // Attach Event Listeners to Update & Remove Buttons
  ...
  // Handle Add or Update Menu Item
  addItemForm.addEventListener("submit", async function (event) {
      ...
      const itemId = addItemForm.dataset.id; // Check if updating an existing item
      ...
      try {
          ...
          if (response.ok) {
              ...
              addItemForm.removeAttribute("data-id"); // Remove update state
  ...
  // Load Menu Item Data into Form for Updating
